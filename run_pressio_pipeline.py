...
parser.add_argument("--halo_exe", default="/anvil/projects/x-cis240669/halo/reeber/build/examples/amr-connected-components/amr_connected_components_float", help="Path to halo executable")
parser.add_argument("--external_script", default="/anvil/projects/x-cis240669/halo/halo_dual_pressio.py", help="Path to halo_dual_pressio.py")
...
if args.external_mode and input_file and len(dims) >= 3:
    ...
    # Unset PYTHONPATH so the subprocess uses only the interpreter's site-packages (avoids
    # loading numpy from libpressio-env's Python 3.11 when running under Python 3.9).
